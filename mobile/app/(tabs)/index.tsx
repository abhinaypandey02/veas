...
import { GET_SUMMARY, GET_CURRENT_USER } from "@/constants/graphql/queries";
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <TouchableOpacity style={styles.crownButton}>
            <MaterialIcons name="workspace-premium" size={26} color="rgba(26,26,26,0.75)" />
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.sectionContainer}>
          ...
          >
            ...
            <View style={styles.heroContent}>
              <Text style={styles.heroSubtitle}>{SUMMARY_ITEMS[0].subtitle}</Text>
          ...
          >
            ...
            <View style={styles.modalHeader}>
              <View style={styles.modalHeaderLeft}>
                ...
                <Text style={styles.modalTitle}>{modalTitle.toLowerCase()}</Text>
              </View>
              <TouchableOpacity
                onPress={() => setModalVisible(false)}
                style={styles.modalClose}
              >
                <MaterialIcons name="close" size={22} color="rgba(0,0,0,0.35)" />
              </TouchableOpacity>
            </View>
